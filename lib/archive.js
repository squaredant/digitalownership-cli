...
function receiptRecord({ sourcePath, archivePath, fingerprint, registration, accountEmail }) {
...
export async function writeArchiveReceipt({ sourcePath, fingerprint, registration, accountEmail, receiptOut, noArchive = false }) {
  ...
  const receipt = receiptRecord({ sourcePath, archivePath, fingerprint, registration, accountEmail });
